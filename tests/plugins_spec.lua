...
local PLUGINS = {
    "addon-inspector", "api-probe", "buff-bars", "crit-tracker", "dps-meter",
    "event-fx", "loot-tracker", "party-frames", "perf-monitor", "player-frame",
    "scene-info", "session-log", "target-frame", "world-clock", "xp-tracker",
}
