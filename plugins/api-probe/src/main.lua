...
return function(Core)
    ...
    addon.command("api", function()
        ...
        log.say("Lua folder: " .. (env.LUA_PATH ~= "" and env.LUA_PATH or "(unknown)"))
        log.say("Data folder: " .. (env.DATA_PATH ~= "" and env.DATA_PATH or "(unknown)"))
    ...
    addon.onStart(function()
        ...
        log.info("commands: /lua _ApiProbe_api | _stats | _buffs | _target | _party"
            .. " | _scene | _inventory | _mouse | _timers")
    end)
